<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupGenericFillerMultiple.aspx.cs" Inherits="lookupGenericFillerMultiple" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent()
        {
            ...
            window.opener.GetValueFrom_lookupGenericFillerMultiple(val1, val2);
            window.close();
            return false;
        }
        function SendValueToParent2(index)
        {
            ...
            var tbc = tbr.cells[0];
            var val1 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupGenericFillerMultiple(val1, tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
            ...
            <tr>
                <td>
                    ...
                    <asp:Panel ID="pnlResult" runat="server" Height="180px" ScrollBars="Both" Width="720px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">
                        <asp:GridView ID="dgvResult" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="716px" OnRowDataBound="Lookup_RowDataBound" OnSelectedIndexChanged="dgvResult_SelectedIndexChanged" OnRowCreated="dgvResult_RowCreated">
            ...
            <tr>
                <td>
                    <asp:Panel ID="pnlSelected" runat="server" GroupingText="SELECTED">
                        <asp:ListBox ID="lbxSelected" runat="server" Width="711px" Height="113px" AutoPostBack="True" OnSelectedIndexChanged="lbxSelected_SelectedIndexChanged"></asp:ListBox>
                    </asp:Panel>
                </td>
            </tr>
            <tr>
