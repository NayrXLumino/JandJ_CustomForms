<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupARRouteAssignment.aspx.cs" Inherits="Maintenance_ApprovalRoute_lookupARRouteAssignment" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function SendValueToParent()
        {
            ...
            window.opener.GetValueFrom_lookupARRouteAssignment(val1, valId, valC1, valC2, valAP);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index)
        {
            ...
            var val1 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupARRouteAssignment(val1, tbcId.innerHTML, tbcC1.innerHTML, tbcC2.innerHTML, tbcAP.innerHTML);
            window.close();
            return false;
        }
