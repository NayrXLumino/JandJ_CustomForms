<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupAORepEmployee.aspx.cs" Inherits="Maintenance_ApprovalRoute_lookupAORepEmployee" %>
...
<head runat="server">
    ...
    function gridSelect(val)
    {
        ...
        document.getElementById('hfNames').value = formatReturnNameValue();
    }
    ...
    function formatReturnNameValue() {
        var lbx = document.getElementById('lbxSelected');
        var retValue = '';
    ...
    function SendValueToParent()
    {
        ...
        var names = document.getElementById('hfNames').value;
        window.opener.GetValueFrom_lookupAORepEmployee(val, names);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        var tbcLastName = tbr.cells[1];
        window.opener.GetValueFrom_lookupAORepEmployee(tbc.innerHTML, tbcLastName.innerHTML);
        window.close();
        return false;
    }
    </script>
                ...
                <td>
                    ...
                    <asp:Panel ID="pnlResult" runat="server" Height="180px" ScrollBars="Both" Width="720px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">
                        <asp:GridView ID="dgvResult" runat="server" BackColor="White" 
                            ...
                            OnSelectedIndexChanging="dgvResult_SelectedIndexChanging">
