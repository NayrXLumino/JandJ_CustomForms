<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeEmployeeApprovalRouteReport.aspx.cs" Inherits="Maintenance_ApprovalRoute_pgeEmployeeApprovalRouteReport" Title="Employee Approval Route Report" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
        ...
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                <asp:TableRow ID="tbrEmployee" runat="server">
                    <asp:TableCell ID="TableCell9" runat="server" Width="120px">
                ...
                <asp:TableRow ID="tbrTransaction" runat="server">
                    <asp:TableCell ID="TableCell12" runat="server" Width="120px">
                        <asp:Label ID="lblTransaction" runat="server" Text="Transaction(s)"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell13" runat="server">
                        <asp:TextBox ID="txtTransaction" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell14" runat="server">
                        <asp:Button ID="btnTransaction" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrCostcenter" runat="server">
                    <asp:TableCell ID="TableCell4" runat="server" Width="120px">
                        <asp:Label ID="lblCostcenter" runat="server" Text="Employee Costcenter(s)"></asp:Label>
                    </asp:TableCell>
