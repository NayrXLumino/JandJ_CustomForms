<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupARCostCenter.aspx.cs" Inherits="Maintenance_ApprovalRoute_lookupARCostcenter" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Cost Center Assignment Lookup</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    <script type="text/javascript">
        function SendValueToParent()
        {
            ...
            var valId = document.getElementById('hfValueId').value;
            var valName = document.getElementById('hfValueName').value;
            window.opener.GetValueFrom_lookupARCostCenter(val1, valId, valName);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index)
        {
            ...
            var tbcName = tbr.cells[1];
            var val1 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupARCostCenter(val1, tbcId.innerHTML, tbcName.innerHTML);
            window.close();
            return false;
        }
        ...
        function  AssignValue(index)
        {
            ...
            document.getElementById('hfValueId').value = tbcId.innerHTML;
            document.getElementById('hfValueName').value = tbcName.innerHTML;
        }
    </script>
</head>
<body>
