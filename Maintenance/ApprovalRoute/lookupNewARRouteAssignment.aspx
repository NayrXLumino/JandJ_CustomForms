<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupNewARRouteAssignment.aspx.cs" Inherits="Maintenance_ApprovalRoute_lookupNewARRouteAssignment" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupNewARRouteAssignment(val1, valId, valC1, valC2, valAP);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var val1 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupNewARRouteAssignment(val1, tbcId.innerHTML, tbcC1.innerHTML, tbcC2.innerHTML, tbcAP.innerHTML);
            window.close();
            return false;
        }
