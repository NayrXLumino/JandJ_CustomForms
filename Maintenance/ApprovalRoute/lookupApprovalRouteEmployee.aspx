<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupApprovalRouteEmployee.aspx.cs" Inherits="Maintenance_ApprovalRoute_lookupApprovalRouteEmployee" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
    	function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupApprovalRouteEmployee(val1, val2, val3);
            window.close();
			return false;
		}
		...
		function SendValueToParent2(index)
        {
            ...
            window.opener.GetValueFrom_lookupApprovalRouteEmployee(tbr.cells[0].innerHTML, tbr.cells[1].innerHTML, tbr.cells[2].innerHTML);
            window.close();
            return false;
        }
