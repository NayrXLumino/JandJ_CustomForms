<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupARRepEmployee.aspx.cs" Inherits="Maintenance_ApprovalRoute_lookupARRepEmployee" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupARRepEmployee(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupARRepEmployee(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
