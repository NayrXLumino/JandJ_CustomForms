<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupAOApproverChecker.aspx.cs" Inherits="Maintenance_ApprovalRoute_lookupAOApproverChecker" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function SendValueToParent()
        {
            ...
            window.opener.GetValueFrom_lookupAOCheckerApprover(val1, valId, valName);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index)
        {
            ...
            var val1 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupAOCheckerApprover(val1, tbcId.innerHTML, tbcName.innerHTML);
            window.close();
            return false;
        }
