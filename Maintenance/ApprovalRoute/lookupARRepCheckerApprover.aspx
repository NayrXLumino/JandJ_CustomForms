<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupARRepCheckerApprover.aspx.cs" Inherits="Maintenance_ApprovalRoute_lookupARRepCheckerApprover" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupARRepCheckerApprover(control,val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupARRepCheckerApprover(control,tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
