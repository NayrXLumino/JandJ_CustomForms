<%@ Page Language="C#" MasterPageFile="~/pgeHELP.master" AutoEventWireup="true" CodeFile="hlpBatchGoupUpdate.aspx.cs" Inherits="Help_Transactions_WorkInformation_Default9" %>
...
<div style="width:630px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Help/Transactions/WorkInformation/Images/BatchGroupUpdate.png" />
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <b>FROM Group</b>: This is an employee's current work group. <br /><br />

                                Lookup for WORK GROUP:<br />
                                <asp:Image ID="Image3" runat="server" ImageUrl="~/Help/Transactions/WorkInformation/Images/IndiGroupUpdate-LookupWorkgroup.png" />
                                <ul>
                                ...
                                <b>TO Shift</b>:  Select a new Shift where an employees will be moved or transferred. <i>You may follow same procedures in</i>  <a href=""><u>Lookup for WORK GROUP.</u></a>
                            </td>
                        </tr>
                        <tr><td colspan="2"><hr /></td></tr>
                        <tr>
