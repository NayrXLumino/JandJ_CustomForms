<%@ Page Language="C#" MasterPageFile="~/pgeHELP.master" AutoEventWireup="true" CodeFile="hlpBatchCostcenterUpdate.aspx.cs" Inherits="Help_Transactions_WorkInformation_Default5" %>
...
<div style="width:630px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Help/Transactions/WorkInformation/Images/BatchCostcenterUpdate.png" />
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table width="100%">
                        <tr>
                            ...
                            <td valign="top">
                                <b>Effectivity Date</b>: Is the date on which this entry will be effective. You can select its date by clicking into thi icon <asp:Image ID="Image2" runat="server" ImageUrl="~/Help/Reusable Images/callendar-icon.bmp" />.
                            </td>
                        </tr>
                        <tr><td colspan="2"><hr /></td></tr>
                        <tr>
                            ...
                            <td>
                                <b>FROM Costcenter</b>: This is an employee's current work group. <br /><br />

                                Lookup for Costcenter:<br />
                                <asp:Image ID="Image3" runat="server" ImageUrl="~/Help/Transactions/WorkInformation/Images/BatchCostcenterUpdate-LookupCostcenter.png" />
                                <ul>
                                    <li>This pop-up window retrieves lists for Costcenters from a data source record.</li>
                                ...
                                <b>TO Costcenter</b>:  Select a new work group where an employees will be moved or transferred. <i>You may follow same procedures in</i>  <a href=""><u>Lookup for Costcenter.</u></a>
                            </td>
                        </tr>
                        <tr><td colspan="2"><hr /></td></tr>
                        <tr>
