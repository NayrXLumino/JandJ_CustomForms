<%@ Page Language="C#" MasterPageFile="~/pgeHELP.master" AutoEventWireup="true" CodeFile="hlpShiftUpdate.aspx.cs" Inherits="Help_Transactions_WorkInformation_Default8" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
     <div style="width:630px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Help/Transactions/WorkInformation/Images/IndiShiftUpdate.png" />
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <b>Process Date</b>:  Is the date on which this entry will be effective. You can select its date by clicking into this icon <asp:Image ID="Image6" runat="server" ImageUrl="~/Help/Reusable Images/callendar-icon.bmp" /> <br /><br />
                                <b>From Shift</b>: This would be an Employee's current/shift.<br /><br />
                                <b>To Shift</b>: Select Shift where an employee will be transafered/moved. To select, click the Lookup Button to view and select shift details. <br /><br /> 
                                Lookup for Shift(s)<br />
                                <asp:Image ID="Image2" runat="server" ImageUrl="~/Help/Transactions/WorkInformation/Images/IndiShiftUpdate-LookupShift.png" />
                                <ul>
                                    <li>This pop-up window retrieves lists of SHIFT from a data source record.</li>
