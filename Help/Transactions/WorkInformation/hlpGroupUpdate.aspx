<%@ Page Language="C#" MasterPageFile="~/pgeHELP.master" AutoEventWireup="true" CodeFile="hlpGroupUpdate.aspx.cs" Inherits="Help_Transactions_WorkInformation_Default" %>
...
<div style="width:630px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Help/Transactions/WorkInformation/Images/IndiGroupUpdate.png" />                    
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <b>FROM Group</b>: This shows an employee's current work group.<br /><br />
                                <b>To Group</b>: Select a new work group where an employee will be moved or transferred.<i>To select, click the lookup button to view its details.</i> <br /><br />
                                Lookup for WORK Group:<br />
                                <asp:Image ID="Image2" runat="server" ImageUrl="~/Help/Transactions/WorkInformation/Images/IndiGroupUpdate-LookupWorkgroup.png" />
                                <ul>
                                    <li>This pop-up window retrieves lists of WORK GROUP from a data source record.</li>
                                    <li>You may record by typing a detail/information from the <b>SEARCH BOX</b>.</li>
                                    <li>You may double click a single row from the list to select it directly.</li>
                                    <li>You may select a row from the list and click the button SELECT to select employee. (<i>Selected row is highlighted with red color background</i>)</li>
                                </ul>
                            </td>
                        </tr>
                        <tr><td colspan="2"><hr /></td></tr>
