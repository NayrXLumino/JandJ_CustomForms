<%@ Page Language="C#" MasterPageFile="~/pgeHELP.master" AutoEventWireup="true" CodeFile="hlpAddressContactReport.aspx.cs" Inherits="Help_Transactions_Personnel_Default" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div style="width:630px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2">
                    <asp:Image ID="Image11" runat="server" ImageUrl="~/Help/Transactions/Personnel/Images/AddressContactReport.png" />
                </td>
            </tr>
                   ...
                   <table width="100%">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/Help/Transactions/Personnel/Images/AddressContactReport-Filter.png" /> <br /><br />
                            <b>1.1</b> You can filter ADDRESS/CONTACT report by <b>Employee, Costcenters, Barangay Municipality or City/Province/District.</b>. <br /><br />
                    ...
                    <tr>
                        ...
                        <td>
                            <br />
                            <b>1.2</b> This is where you can filter Address/Contact by its Effectivity date, Applied, and Endorsed.
                            ...
                            <b>1.3</b> This is where you can filter  Address/Contact by Checkers and its Date Checked. You can type an informations directly from the space provided for you or view its list from the lookup window by cliking the lookup button. <br /><br />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <b>1.4</b> You can filter Address/Contact report by its type. View list type and select by clicking the dropdown control as shown in the image below: <br /><br /> 
                            <asp:Image ID="Image6" runat="server" ImageUrl="~/Help/Transactions/Personnel/Images/AddressContactReport-Filter-Type.png" /> <br /><br />
                            <b>INCLUDE</b>: Is use to select specific Column Header to be inluded in reports as shown below: <br /><br />
                            <asp:Image ID="Image7" runat="server" ImageUrl="~/Help/Transactions/Personnel/Images/AddressContactReport-Include.png" />
                            <ul>
