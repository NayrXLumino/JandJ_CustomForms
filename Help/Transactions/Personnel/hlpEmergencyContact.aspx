<%@ Page Language="C#" MasterPageFile="~/pgeHELP.master" AutoEventWireup="true" CodeFile="hlpEmergencyContact.aspx.cs" Inherits="Help_Transactions_Personnel_Default2" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div style="width:630px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Help/Transactions/Personnel/Images/EmergencyContact.png" />
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <b>Contact Person</b>: You may input in the information in the space provided for you. <br /><br />
                                <b>Contact Relation</b>: <i>Click the lookup button to select a detail/information.</i> <br /><br />
                                Lookup for Contact Relation: <br />
                                <asp:Image ID="Image6" runat="server" ImageUrl="~/Help/Transactions/Personnel/Images/EmergencyContact-LookupContactPerson.png" />
                                 <ul>
                                ...
                                <b>Barangay/Municipality</b>: Click the lookup button to select a detail/information. <i>You may follow procedure from</i>  <a href=""><u>Lookup for Contact Relation</u></a>  <br /><br />
                                <b>City/Province/District</b>: Click the lookup button to select a detail/information. <i>You may follow procedure from</i>  <a href=""><u>Lookup for Contact Relation</u></a>  <br /><br />
                                <b>Telephone Number</b>: You may input in the information in the space provided for you.
                            </td>
                        </tr>
                        <tr><td colspan="2"><hr /></td></tr>
                        <tr>
