<%@ Page Language="C#" MasterPageFile="~/pgeHELP.master" AutoEventWireup="true" CodeFile="hlpEmployeeApprovalRouteReport.aspx.cs" Inherits="Help_Maintenance_ApprovalRoute_Default" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div style="width:630px">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2">
                    <asp:Image ID="ReportEntryForm" runat="server" ImageUrl="~/Help/Maintenance/ApprovalRoute/Images/EmpAppRoute-Report.png" />
                </td>
            </tr>
                   ...
                   <table width="100%">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/Help/Maintenance/ApprovalRoute/Images/EmpAppRouteReport-FILTER.png" /> <br /><br />
                            <b>1.1</b> You can filter Route report by its <b>Route ID, Transaction, Employee Costcenter, Checker 1, CHecker 2, Approver, Status</b>. 
                            <ul>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Image ID="Image5" runat="server" ImageUrl="~/Help/Maintenance/ApprovalRoute/Images/EmpAppRouteReport-GeneratedList.png" /> <br /><br />
