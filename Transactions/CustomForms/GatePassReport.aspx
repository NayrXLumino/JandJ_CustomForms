<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="GatePassReport.aspx.cs" Inherits="Transactions_CustomForms_GatePassReport" Title="Gate Pass Report" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
                                                ...
                                                <asp:Panel ID="pnlGatePassDate" runat="server" GroupingText="GatePass Report Date" Width="390px">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblGatePassDateTo" runat="server" Text="To"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <cc1:GMDatePicker ID="dtpGatePassTo" runat="server" DateFormat="MM/dd/yyyy" CalendarFont-Names="Arial" ShowNoneButton= "false" InitialText="Select a Date" CalendarWidth="150px" Width="120px" TextBoxWidth="90" NoneButtonText="X" TodayButtonStyle-Width="20px" TodayButtonStyle-Height="20px" MonthYearDropDownStyle-Width="40px" MonthYearDropDownStyle-Font-Size="X-Small" TodayButtonText="O" BackColor="Gainsboro" CalendarTheme="Blue" ShowTodayButton="False" CalendarOffsetX="0px" CalendarOffsetY="-160px" MinDate="2000-01-01" InitialValueMode="Null"> 
                                                                            <CalendarDayStyle Font-Size="9pt" />
                                                                            <CalendarTodayDayStyle BorderWidth="1px" BorderColor="DarkRed" Font-Bold="True" Width="20px" />
                                                                            <CalendarOtherMonthDayStyle BackColor="Gainsboro" />
                                                                            <CalendarTitleStyle BackColor="#E0E0E0" Font-Names="Arial" Font-Size="9pt" />
                ...
                <table>
                    ...
                    <td>
                        <asp:Button ID="btnPrint" runat="server" Text="PRINT" Width="100px" 
                            UseSubmitBehavior="false" onclick="btnPrint_Click1" />
                    </td>
                    </tr>
                </table>
            </td>
