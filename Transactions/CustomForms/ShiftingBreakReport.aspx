<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="ShiftingBreakReport.aspx.cs" Inherits="Transactions_CustomForms_ShiftingBreakReport" Title="Gate Pass Report" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
        ...
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                ...
                <asp:TableRow ID="tbrCostcenterLine" runat="server">
                    <asp:TableCell ID="TableCell7" runat="server" Width="120px">
                ...
                <asp:TableRow ID="tbrBatchNo" runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="400px" VerticalAlign="Top">
                                    <asp:Table ID="tblFilter21" runat="server" CellPadding="0" CellSpacing="0">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td style="width:117px">
                                                            <asp:Label ID="lblOTType" runat="server" Text="Type"></asp:Label>
                                                        </td>
                                                        <td>
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlOvertimeDate" runat="server" GroupingText="Overtime Date" Width="390px">
                                                    <table>
                                                        <tr>
                                                            <td>
                                            ...
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlOther" runat="server" GroupingText="Other Option">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblDefaultOt" runat="server" Text="Include Default Overtime"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:CheckBox ID="cbxDefaultOT" runat="server" Text=""/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
    ...
    <div class="dhtmlgoodies_answer" style="width: 896px; height: 1px; left: 0px; top: 0px;">
        <div>
            <asp:Panel ID="pnlInclude" runat="server" Width="895px" GroupingText="Include" Height="75px">
                <asp:CheckBoxList ID="cblInclude" runat="server" Width="884px" RepeatColumns="6">
                    ...
                    <asp:ListItem Value = "Cancelled By">Cancelled By</asp:ListItem>
                    <asp:ListItem Value = "Cancelled Date">Cancelled Date</asp:ListItem>
        ...
        <table cellpadding="0" cellspacing="0" style="width:900px">
            ...
            <td>
                <table>
                    ...
                    <td>
                        <asp:Button ID="btnClear" runat="server" Text="CLEAR" Width="100px" UseSubmitBehavior="false" />
                    </td>
                    <td>
                        <asp:Button ID="btnExport" runat="server" Text="EXPORT" Width="100px" UseSubmitBehavior="false" />
                    </td>
                    <td>
                        <asp:Button ID="btnPrint" runat="server" Text="PRINT" Width="100px" UseSubmitBehavior="false" />
                    </td>
                    </tr>
                </table>
            </td>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSearch" runat="server" Width="398px" AutoPostBack="True" ></asp:TextBox>
                            </td>
                            <td style="width: 72px">
            ...
            <tr>
                <td>
                    <asp:Panel ID="pnlResult" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="350px" ScrollBars="Both" Width="898px" >
                        <asp:GridView ID="dgvResult" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="896px" Font-Size="11px" >
