<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupOTRepCostCenterLine.aspx.cs" Inherits="Transactions_Overtime_lookupOTRepCostCenterLine" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupROTCostcenterLine(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupROTCostcenterLine(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
