<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeCarpassReport.aspx.cs" Inherits="Transactions_Overtime_pgeCarpassReport" Title="Carpass Report" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
        ...
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                <asp:TableRow ID="TableRow1" runat="server">
                    ...
                    <asp:TableCell>
                        <asp:RadioButtonList ID="rblReportType" runat="server" RepeatColumns="2">
                ...
                <td>
                    <asp:Panel ID="pnlResult" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="350px" ScrollBars="Both" Width="898px" >
                        <asp:GridView ID="dgvResult" runat="server" BackColor="White" 
                            ...
                            ForeColor="Black" GridLines="Vertical" Width="882px" Font-Size="11px" 
