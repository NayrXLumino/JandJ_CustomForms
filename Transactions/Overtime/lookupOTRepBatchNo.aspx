<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupOTRepBatchNo.aspx.cs" Inherits="Transactions_Overtime_lookupOTRepBatch" EnableEventValidation="false" %>
...
<head runat="server">
   ...
   <style type="text/css">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupROTBatchNo(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupROTBatchNo(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
