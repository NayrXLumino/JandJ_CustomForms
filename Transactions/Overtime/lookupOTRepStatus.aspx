<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupOTRepStatus.aspx.cs" Inherits="Transactions_Overtime_lookupOTRepStatus" EnableEventValidation="false"%>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupROTStatus(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupROTStatus(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
