<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupOTRepCheckerApprover.aspx.cs" Inherits="Transactions_Overtime_lookupOTRepCheckerApprover" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupROTCheckerApprover(control,val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupROTCheckerApprover(control,tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
