<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupOTRepCostCenter.aspx.cs" Inherits="Transactions_Overtime_lookupOTRepCostCenter" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupROTCostcenter(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupROTCostcenter(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
