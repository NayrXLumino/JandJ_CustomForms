<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupJSRepEmployeeMR.aspx.cs" Inherits="lookupGenericReportsMultiple" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRJSEmployeeMR(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRJSEmployeeMR(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
