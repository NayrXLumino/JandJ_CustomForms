<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pgeCostPerSection.aspx.cs" Inherits="Transactions_ManhourAllocation_pgeCostPerSection" MasterPageFile="~/pgeMaster.master" Title="Cost Per Section Report"%>
...
<script type="text/javascript">
	                    ...
	                    <td colspan="2">
	                        <table style="width: 696px">
	                           ...
	                           <%--<tr style="visibility:hidden">
                                ...
                                <tr>
	                                <td>
                                        <asp:Label ID="Label13" runat="server" Text="Cost Center(s)" Width="124px"></asp:Label>
	                                </td>
	                                <td style="width: 430px">
                                        <asp:TextBox ID="txtCostCenter" runat="server" Width="330px"></asp:TextBox>
         ...
         <asp:Panel ID="pnlResult" runat="server" BorderColor="Black" 
            ...
            Width="898px" Visible="false">
                        ...
                        <dx:ASPxPivotGrid ID="CostPerProjectGrid" runat="server" DataSourceID="SqlDataSource1"
                            ...
                            Width="898">
                            <Fields>
                                <dx:PivotGridField Area="RowArea" AreaIndex="0" Caption="Cost Center" FieldName="COSTCENTERNAME"
                                    ID="fieldCategoryName" Options-AllowDrag="False"  CellStyle-Wrap="False" >
                               ...
                               <%-- <dx:PivotGridField Area="RowArea" AreaIndex="1" Caption="Employee" FieldName="Emt_EmployeeID"
                                ...
                                <dx:PivotGridField Area="DataArea" AreaIndex="0" Caption="Hours" 
                                    FieldName="TOTAL" Options-AllowDrag="False"
                                    ID="HRS" CellFormat-FormatType="Numeric" />
                                <dx:PivotGridField Area="ColumnArea"  AreaIndex="0"  
                                    FieldName="Slm_ClientJobName" ID="MONTHS" Caption="Project Names" Options-AllowDrag="False"
                                    />
                            </Fields>
    ...
    <asp:Panel ID="Panel12" runat="server" Visible="false" Width="897px">
        </td>
