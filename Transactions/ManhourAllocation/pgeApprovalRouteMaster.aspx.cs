...
public partial class Maintenance_ApprovalRoute_pgeApprovalRouteMaster : System.Web.UI.Page
{
            ...
            if (Page.IsValid)
            {
                ...
                { 
                    case "NEW":
                        ...
                        txtCostCenterDesc.Text = string.Empty;
                    ...
                    case "CREATE":
                        ...
                        if (err.Equals(string.Empty))
                        {
                            ...
                            MessageBox.Show("Successfully created new approval route.");
                            btnX.Text = "NEW";
                            btnY.Text = "EDIT";
    ...
    private void setDetailInformation()
    {
        ...
        string sql = @" SELECT Arm_RouteId [Route ID]
                             ...
                             , dbo.getCostCenterFullNameV2(Arm_CostcenterCode) [Cost Center Desc]
                             , Arm_Status [Status]
