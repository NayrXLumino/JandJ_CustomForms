<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeRManHours.aspx.cs" Inherits="Default2" Title="Manhour Report" %>
    ...
    <div class="bodyContent" >
	        ...
	        <div>
	            <table style="width:895px;">
	                    ...
	                    <td colspan="2">
	                        <table style="width: 696px">
                                ...
                                <tr>
	                                ...
	                                <td style="width: 754px">
                                        <asp:TextBox ID="txtEmpName" runat="server" Width="710px"></asp:TextBox>
	                                </td>
	                                <td>
	                            ...
	                            <tr>
	                                ...
	                                <table style="width: 100%">
	                                    <tr>
        	                                ...
        	                                <asp:RadioButtonList ID="rblBillable" runat="server" RepeatDirection="Horizontal" Width="400px" Height="19px">
                                                <asp:ListItem Value="A">All&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</asp:ListItem>
                                                <asp:ListItem Value="B">Billable&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</asp:ListItem>
                                                <asp:ListItem Value="N">NON-BILLABLE</asp:ListItem>
                                                <asp:ListItem Value="X">NON JOBS</asp:ListItem>
                                            </asp:RadioButtonList>
	                                        </td>
	                                        <td style="text-align: right; padding-right: 75px;">
	                                        <asp:CheckBox ID="cbUnsplitted" runat="server" Height="19px" Text="Include Unallocated "
                                            TextAlign="Left" Width="128px" Visible="false" />
                                            </td>
	                                    </tr>
	                                </table>
	                                </td>
	                            ...
	                            <tr style="display:none"> <%--hide temporarily this row--%>
	                ...
	                <tr>
	                    ...
	                    <td style="width:335px; display:none;" valign="top">
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblReport" runat="server" Text="Report" Width="55px"/>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlReport" runat="server" Width="300px">
                                            ...
                                            <asp:ListItem Text="Custom Department Manhour" Value="16" />
                                            ...
                                            <%--<asp:ListItem Text="ACTUAL MH SUMMARY" Value="14" />
                                            <asp:ListItem Text="ACTUAL MH DATA SHEET" Value="15" />
                        ...
                        <td>
                            ...
                            <asp:RadioButtonList ID="rblInclude" runat="server" RepeatDirection="Horizontal" Width="300px">
                                <asp:ListItem Value="">None</asp:ListItem>
                                <asp:ListItem Value="M">MM/MS</asp:ListItem>
                                <asp:ListItem Value="F">FBS</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblProfile" runat="server" Text="Profile" Width="50px"/>
                                    </td>
                                    <td>
                                        <asp:CheckBoxList ID="cblProfile" runat="server" RepeatDirection="Horizontal" RepeatColumns="4" />
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" BorderStyle="Solid" BorderWidth="1px" Width="898px">
            ...
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="false" 
                 ClientInstanceName="ASPxGridView1" Visible="False" 
                 SettingsPager-PageSize="30" Width="100%" 
                 ...
                 <GroupSummary>
                    <dx:ASPxSummaryItem FieldName="Work Description" SummaryType="Sum" ShowInGroupFooterColumn="Work Description"/>
                    <dx:ASPxSummaryItem FieldName="Job Description" SummaryType="Sum" ShowInGroupFooterColumn="Job Description"/>
                    <dx:ASPxSummaryItem FieldName="REG" SummaryType="Sum" ShowInGroupFooterColumn="REG" DisplayFormat="0.00" />
                    <dx:ASPxSummaryItem FieldName="OT" SummaryType="Sum" ShowInGroupFooterColumn="OT" DisplayFormat="0.00"  />
                    <dx:ASPxSummaryItem FieldName="Manhours" SummaryType="Sum" ShowInGroupFooterColumn="Manhours" DisplayFormat="0.00"  />
                 </GroupSummary>
