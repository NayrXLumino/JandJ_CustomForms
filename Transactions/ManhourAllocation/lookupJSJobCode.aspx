<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupJSJobCode.aspx.cs" Inherits="Transactions_ManhourAllocation_lookupJSJobCode" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function AssignValue(index) 
        {
            ...
            var tbc4 = tbr.cells[3];
            var tbc5 = tbr.cells[4];
            ...
            document.getElementById('hfCostCenter').value = tbc4.innerHTML;
            document.getElementById('hfCategory').value = tbc5.innerHTML;
        }
        ...
        function SendValueToParent() {
            ...
            var val4 = document.getElementById('hfCategory').value;
            var val5 = document.getElementById('hfCostCenter').value;

            window.opener.GetValueFrom_lookupJSJobCode(val1, val2, val3, val4, val5);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            window.opener.GetValueFrom_lookupJSJobCode(tbr.cells[0].innerHTML, tbr.cells[1].innerHTML, tbr.cells[2].innerHTML, tbr.cells[4].innerHTML, tbr.cells[3].innerHTML);
            window.close();
            return false;
        }
                ...
                <td style="width: 717px">
                    <table style="width: 710px">
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:DropDownList ID="ddlCostCenter" runat="server" Width="584px" 
                                    Font-Size="11px" onselectedindexchanged="ddlCostCenter_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </td>
                            <td>
                                <asp:CheckBox ID="cbxExtension" runat="server" Text="EXT" 
                                    oncheckedchanged="cbxExtension_CheckedChanged" AutoPostBack="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>
