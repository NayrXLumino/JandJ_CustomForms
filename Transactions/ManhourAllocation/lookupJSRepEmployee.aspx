<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupJSRepEmployee.aspx.cs" Inherits="lookupGenericReportsMultiple" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRJSEmployee(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRJSEmployee(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
