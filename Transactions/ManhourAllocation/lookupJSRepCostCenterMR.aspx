<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupJSRepCostCenterMR.aspx.cs" Inherits="Transactions_ManhourAllocation_lookupJSRepCostCenter" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRJSCostcenter(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRJSCostcenter(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
