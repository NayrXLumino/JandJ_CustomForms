<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepStatus.aspx.cs" Inherits="Transactions_Leave_lookupLVRepStatus" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRLVStatus(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRLVStatus(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
