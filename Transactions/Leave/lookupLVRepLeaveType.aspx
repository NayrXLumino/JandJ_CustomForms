<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepLeaveType.aspx.cs" Inherits="Transactions_Leave_lookupLVRepLeaveType" EnableEventValidation="false" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Leave Type Lookup</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRLVType(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRLVType(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
