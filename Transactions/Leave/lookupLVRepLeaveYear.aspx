<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepLeaveYear.aspx.cs" Inherits="Transactions_Leave_lookupLVRepLeaveYear" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Leave Year Lookup</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRLVLeaveYear(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRLVLeaveYear(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
