<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepCategory.aspx.cs" Inherits="Transactions_Leave_lookupLVRepCategory" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Leave Category Lookup</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRLVCategory(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRLVCategory(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
