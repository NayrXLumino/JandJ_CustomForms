<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeLeaveIndividual.aspx.cs" Inherits="Transactions_Leave_pgeLeaveIndividual" Title="Individual Leave Entry" EnableEventValidation="false" %>
            ...
            <asp:Table ID="tblLeftControls" runat="server" Width="440px">
                <asp:TableRow ID="tbrControlNo" runat="server">
                    ...
                    <asp:TableCell ID="TableCell2" runat="server">
                        ...
                        <asp:Button ID="btnLeaveNotice" runat="server" Text="..." UseSubmitBehavior="false" Width="22px" BackColor="Red" ForeColor="White" ToolTip="Unendorsed Leave Notice(s). Click to View." />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="TableRow1" runat="server">
                    <asp:TableCell ID="TableCell3" runat="server">
                        <asp:Label ID="lblOTDate" runat="server" Text="Date of Leave"></asp:Label>
                    </asp:TableCell>
                ...
                <asp:TableRow ID="TableRow4" runat="server" VerticalAlign="top">
                    ...
                    <asp:TableCell ID="TableCell10" runat="server">
                        <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Width="295px" MaxLength="200"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="TableRow9" runat="server" VerticalAlign="top">
                    <asp:TableCell ID="TableCell19" runat="server">
                        <asp:Label ID="Label2" runat="server" Text="Employee Default Shift"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell20" runat="server">
                        <asp:TextBox ID="txtDefaultShift" runat="server" Width="290px" ReadOnly="true" BackColor="Gainsboro"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="TableRow8" runat="server" VerticalAlign="top">
                    <asp:TableCell ID="TableCell17" runat="server">
                        <asp:Label ID="Label1" runat="server" Text="Current Cycle"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell18" runat="server">
                        <asp:TextBox ID="txtCurrentCycle" runat="server" Width="290px" ReadOnly="true" BackColor="Gainsboro"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tblClinicCertificates" runat="server">
                    <asp:TableCell ColumnSpan="2">
                        <asp:Panel ID="pnlCertificates" runat="server" Width="380px" GroupingText="Certificates" >
                        <div id="divCertificates" runat="server" style="width:50%; height:auto;">
                        
                        </div>
                        </asp:Panel>
                        <asp:HiddenField ID="hfClinicRec" runat="server" />
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </td>
        ...
        <td colspan="2">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnY" runat="server" Text="[btnY]" Width="225px" OnClientClick="return clearControls()" OnClick="btnY_Click" />
                    </td>
                    <td>
...
<asp:HiddenField ID="hfLHRSINDAY" runat="server"/>
<asp:HiddenField ID="hfLVHRENTRY" runat="server"/>
<asp:HiddenField ID="hfDAYSEL" runat="server"/>
<asp:HiddenField ID="hfValueWH" runat="server"/>
<asp:HiddenField ID="hfValueHA" runat="server"/>
<asp:HiddenField ID="hfValueHP" runat="server"/>
<asp:HiddenField ID="hfValueQR" runat="server"/>
...
<asp:HiddenField ID="hfNoticeFlag" runat="server" Value="FALSE"/>
