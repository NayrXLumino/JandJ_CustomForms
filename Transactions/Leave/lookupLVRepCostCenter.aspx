<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepCostCenter.aspx.cs" Inherits="Transactions_Leave_lookupLVRepCostCenter" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRLVCostcenter(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRLVCostcenter(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
