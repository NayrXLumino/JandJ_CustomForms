<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeLeaveReport.aspx.cs" Inherits="Transactions_Leave_pgeLeaveReport" EnableEventValidation="false" Title="Leave Report" %>
    ...
    <div class="dhtmlgoodies_answer" style="width: 895px; height: 1px; left: 0px; top: 0px;">
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                ...
                <asp:TableRow ID="tbrLeaveCategory" runat="server">
                    <asp:TableCell ID="TableCell25" runat="server">
                        <asp:Label ID="lblLeaveCategory" runat="server" Text="Category(s)"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell26" runat="server">
                        <asp:TextBox ID="txtCategory" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell27" runat="server">
                        <asp:Button ID="btnCategory" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrDayUnit" runat="server">
                    <asp:TableCell ID="TableCell28" runat="server">
                        <asp:Label ID="lblDayUnit" runat="server" Text="Day Unit(s)"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell29" runat="server">
                        <asp:TextBox ID="txtDayUnit" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell30" runat="server">
                        <asp:Button ID="btnDayUnit" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="400px" VerticalAlign="Top">
                                    <asp:Table ID="tblFilter21" runat="server" CellPadding="0" CellSpacing="0">
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlOvertimeDate" runat="server" GroupingText="Leave Date" Width="390px">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblLVDateFrom" runat="server" Text="From"></asp:Label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblLVDateTo" runat="server" Text="To"></asp:Label>
                                                            </td>
                                                            <td>
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlEndorsedDate" runat="server" GroupingText="Endorsed Date" Width="390px">
                                                    <table>
                                                        <tr>
                                                            <td>
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlInformDate" runat="server" GroupingText="Inform Date" Width="390px">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <cc1:GMDatePicker ID="dtpInformDateFrom" runat="server" DateFormat="MM/dd/yyyy" CalendarFont-Names="Arial" ShowNoneButton= "false" InitialText="Select a Date" CalendarWidth="150px" Width="120px" TextBoxWidth="90" NoneButtonText="X" TodayButtonStyle-Width="20px" TodayButtonStyle-Height="20px" MonthYearDropDownStyle-Width="40px" MonthYearDropDownStyle-Font-Size="X-Small" TodayButtonText="O" BackColor="Gainsboro" CalendarTheme="Blue" ShowTodayButton="False" CalendarOffsetX="0px" CalendarOffsetY="-160px" MinDate="2000-01-01" InitialValueMode="Null"> 
                                                                            <CalendarDayStyle Font-Size="9pt" />
                                                                            <CalendarTodayDayStyle BorderWidth="1px" BorderColor="DarkRed" Font-Bold="True" Width="20px" />
                                                                            <CalendarOtherMonthDayStyle BackColor="Gainsboro" />
                                                                            <CalendarTitleStyle BackColor="#E0E0E0" Font-Names="Arial" Font-Size="9pt" />
                                                            ...
                                                            <td>
                                                                <cc1:GMDatePicker ID="dtpInformDateTo" runat="server" DateFormat="MM/dd/yyyy" CalendarFont-Names="Arial" ShowNoneButton= "false" InitialText="Select a Date" CalendarWidth="150px" Width="120px" TextBoxWidth="90" NoneButtonText="X" TodayButtonStyle-Width="20px" TodayButtonStyle-Height="20px" MonthYearDropDownStyle-Width="40px" MonthYearDropDownStyle-Font-Size="X-Small" TodayButtonText="O" BackColor="Gainsboro" CalendarTheme="Blue" ShowTodayButton="False" CalendarOffsetX="0px" CalendarOffsetY="-160px" MinDate="2000-01-01" InitialValueMode="Null"> 
                                                                            <CalendarDayStyle Font-Size="9pt" />
                                                                            <CalendarTodayDayStyle BorderWidth="1px" BorderColor="DarkRed" Font-Bold="True" Width="20px" />
                                                                            <CalendarOtherMonthDayStyle BackColor="Gainsboro" />
                                                                            <CalendarTitleStyle BackColor="#E0E0E0" Font-Names="Arial" Font-Size="9pt" />
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlNotice" runat="server" GroupingText="Leave Notice" Width="390px">
                                                    <asp:CheckBox ID="cbxLeaveNotice" runat="server" Text="View Leave Notice Transaction(s)" TextAlign="Left" Checked="false" />
                                                </asp:Panel>
                                            </asp:TableCell>
                                        </asp:TableRow>
                                        <asp:TableRow>
