<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepEmployee.aspx.cs" Inherits="Transactions_Leave_lookupLVRepEmployee" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRLVEmployee(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRLVEmployee(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
            ...
            <tr>
                <td>
                    ...
                    <asp:Panel ID="pnlResult" runat="server" Height="180px" ScrollBars="Both" Width="720px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">
                        <asp:GridView ID="dgvResult" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="100%" OnRowDataBound="Lookup_RowDataBound" OnSelectedIndexChanged="dgvResult_SelectedIndexChanged" OnRowCreated="dgvResult_RowCreated" OnSelectedIndexChanging="dgvResult_SelectedIndexChanging">
