<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepCostcenterLine.aspx.cs" Inherits="Transactions_Leave_lookupLVRepCostcenterLine" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRLVCostcenterLine(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRLVCostcenterLine(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
