<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepCheckerApprover.aspx.cs" Inherits="Transactions_Leave_lookupLVRepCheckerApprover" EnableEventValidation="false" %>
...
<head runat="server">
   <title>Checker/Approver Lookup</title>
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRLVCheckerApprover(control,val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRLVCheckerApprover(control,tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
