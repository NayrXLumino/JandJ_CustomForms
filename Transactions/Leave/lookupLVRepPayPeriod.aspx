<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVRepPayPeriod.aspx.cs" Inherits="Transactions_Leave_lookupLVRepPayPeriod" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRLVPayPeriod(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRLVPayPeriod(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
