<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupLVLeaveNoticeOnEntry.aspx.cs" Inherits="Transactions_Leave_lookupLVLeaveNoticeOnEntry" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Leave Notice(s) Lookup</title>
     <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    <script type="text/javascript">
        function SendValueToParent()
        {
            ...
            window.opener.GetValueFrom_lookupLVLeaveNoticeOnEntry( vEmployeeId
                                                                 , vEmployeeName
                                                                 , vEmployeeNickname
                                                                 , vControlNo);
            window.close();
        ...
        function SendValueToParent2(index)
        {
            ...
            window.opener.GetValueFrom_lookupLVLeaveNoticeOnEntry( vEmployeeId.innerHTML
        ...
        function  AssignValue(index)
        {
            ...
            document.getElementById('hfEmployeeId').value = tbr.cells[1].innerHTML;
            document.getElementById('hfEmployeeName').value = tbr.cells[2].innerHTML;
            document.getElementById('hfEmployeeNickName').value = tbr.cells[3].innerHTML;
            document.getElementById('hfControlNo').value = tbr.cells[0].innerHTML;
