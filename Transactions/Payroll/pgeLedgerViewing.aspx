<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeLedgerViewing.aspx.cs" Inherits="Transactions_Payroll_pgeLedgerViewing" Title="Ledger Viewing" %>
        ...
        <asp:MultiView ID="mtvPayslipViewing" runat="server" ActiveViewIndex="0">
            <asp:View ID="mtvVerify" runat="server">
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="Enter Ledger Password" Font-Bold="True" Width="140px"></asp:Label> 
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnChangePassword" runat="server" Text="Change Password" 
                                UseSubmitBehavior="false" Width="300px" onclick="btnChangePassword_Click"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
