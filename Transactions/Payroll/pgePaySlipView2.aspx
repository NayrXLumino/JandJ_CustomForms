<%@ Page Title="" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgePaySlipView2.aspx.cs" Inherits="Transactions_Payroll_pgePaySlipView2" %>
                            ...
                            <asp:Panel ID="pnlChargePassword" runat="server" GroupingText="Change Password" Width="405px" Visible="false">
                                <table style="text-align:left" width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCurrentPassword" runat="server" TextMode="Password" Width="225px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txConfirmPassword" runat="server" TextMode="Password" Width="225px"></asp:TextBox>
