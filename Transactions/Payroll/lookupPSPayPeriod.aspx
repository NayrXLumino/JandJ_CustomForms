<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupPSPayPeriod.aspx.cs" Inherits="Transactions_Payroll_lookupPSPayPeriod" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Lookup Pay Period</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    <script type="text/javascript">
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupPSPayPeriod(val1, val2);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            window.opener.GetValueFrom_lookupPSPayPeriod(tbcCode.innerHTML, tbcDesc.innerHTML);
            window.close();
            return false;
        }
