<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="lookupPRRepEmployee.aspx.cs" Inherits="Transactions_Payroll_lookupPRRepEmployee" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupPREmployee(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupPREmployee(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
