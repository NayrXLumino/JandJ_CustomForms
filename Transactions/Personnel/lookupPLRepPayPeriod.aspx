<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupPLRepPayPeriod.aspx.cs" Inherits="Transactions_Personnel_lookupPLRepPayPeriod" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRPLPayPeriod(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRPLPayPeriod(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
