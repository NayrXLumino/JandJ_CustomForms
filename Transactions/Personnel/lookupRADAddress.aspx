<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupRADAddress.aspx.cs" Inherits="Transactions_Personnel_lookupRADAddress2" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<%-- Generic lookup for those who use accountdetail table in DB --%>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRTCTaxCode(control,val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRTCTaxCode(control,tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
            ...
            <tr>
                <td>
                    ...
                    <asp:Panel ID="pnlResult" runat="server" Height="180px" ScrollBars="Both" Width="720px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">
                        <asp:GridView ID="dgvResult" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="704px" OnRowDataBound="Lookup_RowDataBound" OnSelectedIndexChanged="dgvResult_SelectedIndexChanged" OnRowCreated="dgvResult_RowCreated" OnSelectedIndexChanging="dgvResult_SelectedIndexChanging">
