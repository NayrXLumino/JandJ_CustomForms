<%@ Page Title="Address Report" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeAddressReport.aspx.cs" Inherits="Transactions_Personnel_pgeAddressReport" %>
        ...
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                ...
                <asp:TableRow ID="tbrAddress2" runat="server">
                    ...
                    <asp:TableCell runat="server">
                        <asp:TextBox ID="txtAddress2" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell runat="server">
                        <asp:Button ID="btnAddress2" runat="server" Text="..." UseSubmitBehavior="false" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrAddress3" runat="server">
                    <asp:TableCell ID="TableCell10" runat="server">
                        <asp:Label ID="Label1" runat="server" Text="City/Province/District"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell11" runat="server">
                        <asp:TextBox ID="txtAddress3" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell12" runat="server">
                        <asp:Button ID="btnAddress3" runat="server" Text="..." UseSubmitBehavior="false" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td style="width:117px">
                                                            <asp:Label ID="lblAddressType" runat="server" Text="Type"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlAddressType" runat="server" Width="150px">
                                                                <asp:ListItem Selected="True" Value="">ALL</asp:ListItem>
                                                                <asp:ListItem Value="A1">Present</asp:ListItem>
                                                                <asp:ListItem Value="A2">Permanent</asp:ListItem>
                                                                <asp:ListItem Value="A3">Emergency Contact</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
