<%@ Page Title="Beneficiary Update Report" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeBeneficiaryUpdateReport.aspx.cs" Inherits="Transactions_Personnel_pgeBeneficiaryUpdateReport" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
    ...
    <div class="dhtmlgoodies_answer" style="width: 895px; height: 1px; left: 0px; top: 0px;">
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                ...
                <asp:TableRow ID="tbrLastname" runat="server">
                    <asp:TableCell ID="TableCell13" runat="server">
                        <asp:Label ID="lblLastname" runat="server" Text="Lastname(s)"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell14" runat="server">
                        <asp:TextBox ID="txtLastname" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell15" runat="server">
                        <asp:Button ID="btnLastname" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrFirstname" runat="server">
                    <asp:TableCell ID="TableCell25" runat="server">
                        <asp:Label ID="lblFirstname" runat="server" Text="Firstname(s)"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell26" runat="server">
                        <asp:TextBox ID="txtFirstname" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell27" runat="server">
                        <asp:Button ID="btnFirstname" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrMiddlename" runat="server" Visible="false">
                    <asp:TableCell ID="TableCell16" runat="server">
                        <asp:Label ID="lblMiddlename" runat="server" Text="Middlename(s)"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell17" runat="server">
                        <asp:TextBox ID="txtMiddlename" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell18" runat="server">
                        <asp:Button ID="btnMiddlename" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrRelationShip" runat="server" Visible="false">
                    <asp:TableCell ID="TableCell19" runat="server">
                        <asp:Label ID="lblRelationship" runat="server" Text="Relationship(s)"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell20" runat="server">
                        <asp:TextBox ID="txtRelationship" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                ...
                <asp:TableRow ID="tbrHierarchy" runat="server" Visible="false">
                    ...
                    <asp:TableCell ID="TableCell23" runat="server">
                        <asp:TextBox ID="txtHierarchy" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell24" runat="server">
                        <asp:Button ID="btnHierarchy" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrDependent" runat="server">
                    ...
                    <asp:TableCell ID="TableCell29" runat="server">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td align="right">
                                    <asp:Label ID="Label4" runat="server" Text="HMO"></asp:Label>
                                </td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlHMO" runat="server">
                                ...
                                <td align="right">
                                    <asp:Label ID="Label5" runat="server" Text="Insurance"></asp:Label>
                                </td>
                                <td align="left">
                                ...
                                <td align="right">
                                    <asp:Label ID="Label6" runat="server" Text="BIR"></asp:Label>
                                </td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlBIR" runat="server">
                                        <asp:ListItem Value=""></asp:ListItem>
                                        <asp:ListItem Value="1">YES</asp:ListItem>
                                        <asp:ListItem Value="0">NO</asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <td align="right">
                                    <asp:Label ID="Label7" runat="server" Text="Accident"></asp:Label>
                                </td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlAccident" runat="server">
                                        <asp:ListItem Value=""></asp:ListItem>
                                        <asp:ListItem Value="1">YES</asp:ListItem>
                                        <asp:ListItem Value="0">NO</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="400px" VerticalAlign="Top">
                                    <asp:Table ID="tblFilter21" runat="server" CellPadding="0" CellSpacing="0">
                                                ...
                                                <asp:Panel ID="pnlEffectivityDate" runat="server" GroupingText="Effectivity Date" Width="390px">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <cc1:GMDatePicker ID="dtpEffDateTo" runat="server" DateFormat="MM/dd/yyyy" CalendarFont-Names="Arial" ShowNoneButton= "false" InitialText="Select a Date" CalendarWidth="150px" Width="120px" TextBoxWidth="90" NoneButtonText="X" TodayButtonStyle-Width="20px" TodayButtonStyle-Height="20px" MonthYearDropDownStyle-Width="40px" MonthYearDropDownStyle-Font-Size="X-Small" TodayButtonText="O" BackColor="Gainsboro" CalendarTheme="Blue" ShowTodayButton="False" CalendarOffsetX="0px" CalendarOffsetY="-160px" MinDate="1600-01-01" InitialValueMode="Null"> 
                                                                            <CalendarDayStyle Font-Size="9pt" />
                                                                            <CalendarTodayDayStyle BorderWidth="1px" BorderColor="DarkRed" Font-Bold="True" Width="20px" />
                                                                            <CalendarOtherMonthDayStyle BackColor="Gainsboro" />
                                                                            <CalendarTitleStyle BackColor="#E0E0E0" Font-Names="Arial" Font-Size="9pt" />
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlBirthdate" runat="server" GroupingText="Birthdate" Width="390px">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <cc1:GMDatePicker ID="dtpBirthDateFrom" runat="server" DateFormat="MM/dd/yyyy" CalendarFont-Names="Arial" ShowNoneButton= "false" InitialText="Select a Date" CalendarWidth="150px" Width="120px" TextBoxWidth="90" NoneButtonText="X" TodayButtonStyle-Width="20px" TodayButtonStyle-Height="20px" MonthYearDropDownStyle-Width="40px" MonthYearDropDownStyle-Font-Size="X-Small" TodayButtonText="O" BackColor="Gainsboro" CalendarTheme="Blue" ShowTodayButton="False" CalendarOffsetX="0px" CalendarOffsetY="-160px" MinDate="1600-01-01" InitialValueMode="Null"> 
                                                                            <CalendarDayStyle Font-Size="9pt" />
                                                                            <CalendarTodayDayStyle BorderWidth="1px" BorderColor="DarkRed" Font-Bold="True" Width="20px" />
                                                                            <CalendarOtherMonthDayStyle BackColor="Gainsboro" />
                                                                            <CalendarTitleStyle BackColor="#E0E0E0" Font-Names="Arial" Font-Size="9pt" />
                                                ...
                                                <asp:Panel ID="pnlChec1ker" runat="server" Width="470px" GroupingText="Checker 1">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <cc1:GMDatePicker ID="dtpC1To" runat="server" DateFormat="MM/dd/yyyy" CalendarFont-Names="Arial" ShowNoneButton= "false" InitialText="Select a Date" CalendarWidth="150px" Width="120px" TextBoxWidth="90" NoneButtonText="X" TodayButtonStyle-Width="20px" TodayButtonStyle-Height="20px" MonthYearDropDownStyle-Width="40px" MonthYearDropDownStyle-Font-Size="X-Small" TodayButtonText="O" BackColor="Gainsboro" CalendarTheme="Blue" ShowTodayButton="False" CalendarOffsetX="-177px" CalendarOffsetY="-160px" MinDate="1600-01-01" InitialValueMode="Null"> 
                                                                            <CalendarDayStyle Font-Size="9pt" />
                                                                            <CalendarTodayDayStyle BorderWidth="1px" BorderColor="DarkRed" Font-Bold="True" Width="20px" />
                                                                            <CalendarOtherMonthDayStyle BackColor="Gainsboro" />
                                                                            <CalendarTitleStyle BackColor="#E0E0E0" Font-Names="Arial" Font-Size="9pt" />
