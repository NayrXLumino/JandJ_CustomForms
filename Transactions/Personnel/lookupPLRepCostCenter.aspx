<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupPLRepCostCenter.aspx.cs" Inherits="Transactions_Personnel_lookupPLRepCostCenter" EnableEventValidation="false"  %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRPLCostcenter(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRPLCostcenter(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
