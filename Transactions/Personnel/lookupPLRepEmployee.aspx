<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupPLRepEmployee.aspx.cs" Inherits="Transactions_Personnel_lookupTCRepEmployee" EnableEventValidation="false"  %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRPLEmployee(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRPLEmployee(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
