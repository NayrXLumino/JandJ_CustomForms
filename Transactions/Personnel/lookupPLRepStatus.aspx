<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupPLRepStatus.aspx.cs" Inherits="Transactions_Personnel_lookupPLRepStatus" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRPLStatus(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRPLStatus(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
