...
public partial class Transactions_Personnel_pgeAddressEmergency : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (!MGBL.getAccessRights(Session["userLogged"].ToString(), "WFADDEMER"))
        {
        ...
        else
        {
            ...
            LoadComplete += new EventHandler(Transactions_Personnel_pgeAddressEmergency_LoadComplete);
    ...
    void Transactions_Personnel_pgeAddressEmergency_LoadComplete(object sender, EventArgs e)
    {
        ...
        txtContactRelationCode.Attributes.Add("readOnly", "true");
        txtContactRelationDesc.Attributes.Add("readOnly", "true");
        ...
        btnContactRelation.Attributes.Add("OnClick", "javascript:return lookupAccountCodeDesc(" + "'txtContactRelation','RELATION');");
                        ...
                        using (DALHelper dal = new DALHelper())
                        {
                            ...
                            if (!status.Equals(string.Empty))
                            {
                                ...
                                try
                                {
                                    ...
                                    //MenuLOg
                                    SystemMenuLogBL.InsertEditLog("WFADDEMER", true, txtEmployeeId.Text.ToString().ToUpper(), Session["userLogged"].ToString(), "");
                    ...
                    if (errMsg1.Equals(string.Empty))
                    {
                        using (DALHelper dal = new DALHelper())
                        {
                            try
                            {
                                ...
                                //MenuLog
                                SystemMenuLogBL.InsertAddLog("WFADDEMER", true, txtEmployeeId.Text.ToString().ToUpper(), Session["userLogged"].ToString(), "");
                                //
                                dal.CommitTransactionSnapshot();
                            }
                            catch (Exception ex)
    ...
    {
        MenuGrant userGrant = new MenuGrant(Session["userLogged"].ToString(), "PERSONNEL", "WFADDEMER");
    ...
    private void initializeCurrentValues()
    {
        ...
        string sqlAddress = @"  SELECT Emt_ContactAddress1 [Address1]
                                     ...
                                     , Emt_ContactPersonNo [Telephone No]
                                     , Emt_ContactPersonName [ContactPerson]
                                     , Relation.Adt_AccountCode [ContactRelationCode]
                                     , Relation.Adt_AccountDesc [ContactRelationDesc]
                                  FROM T_EmployeeMaster
                                  LEFT JOIN T_AccountDetail Address2
                                    ON Address2.Adt_AccountCode = Emt_ContactAddress2
                                   AND Address2.Adt_AccountType = 'BARANGAY'
                                  LEFT JOIN T_AccountDetail Address3
                                    ON Address3.Adt_AccountCode = Emt_ContactAddress3
                                   AND Address3.Adt_AccountType = 'ZIPCODE'
                                  LEFT JOIN T_AccountDetail Relation
                                    ON Relation.Adt_AccountCode = Emt_ContactRelation
                                   AND Relation.Adt_AccountType = 'RELATION'
        ...
        if (!CommonMethods.isEmpty(dsAddress))
        {
            ...
            txtContactPerson.Text = dsAddress.Tables[0].Rows[0]["ContactPerson"].ToString();
            txtContactRelationCode.Text = dsAddress.Tables[0].Rows[0]["ContactRelationCode"].ToString();
            txtContactRelationDesc.Text = dsAddress.Tables[0].Rows[0]["ContactRelationDesc"].ToString();
        }
        else
        {
            ...
            txtContactRelationCode.Text = string.Empty;
            txtContactRelationDesc.Text = "     -  INVALID RELATION CODE . Code is not in master.  -";
        }
        #endregion
    }
    ...
    private void enableControls()  
    {
        ...
        switch (txtStatus.Text.ToUpper())
        {
            case "":
                ...
                btnContactRelation.Enabled = true;
            ...
            case "ENDORSED TO CHECKER 1":
                ...
                btnContactRelation.Enabled = false;
    ...
    private DataRow PopulateDR(string Status, string ControlNum)
    {
        ...
        dr["Amt_ContactPerson"] = txtContactPerson.Text.ToUpper();
        dr["Amt_ContactRelation"] = txtContactRelationCode.Text;
    ...
    private string changeSnapShot()
    {
        ...
        snapShot = dtpEffectivityDate.Date.ToString()
                 ...
                 + txtContactRelationCode.Text
                 + txtContactRelationDesc.Text                
                 + txtReason.Text;
        return snapShot;
    }
    ...
    private void restoreDefaultControls()
    {
        ...
        txtContactRelationCode.Text = string.Empty;
        txtContactRelationDesc.Text = string.Empty;
    ...
    private void loadTransactionDetail()
    {
        ...
        txtContactRelationCode.Text = dr["ContactRelation"].ToString();
        txtContactRelationDesc.Text = dr["ContactRelationDesc"].ToString();
        ...
        {
            string pageUrl = @"pgeAddressEmergency.aspx";
