<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeTaxCodeCivilStatusReport.aspx.cs" Inherits="Transactions_Payroll_pgeTaxCodeCivilStatusReport" Title="Tax Code / Civil Status Report" %>
        ...
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                ...
                <asp:TableRow ID="tbrCostcenterLine" runat="server">
                    <asp:TableCell ID="TableCell28" runat="server" Width="120px">
                ...
                <asp:TableRow ID="tbrTaxCodeFrom" runat="server">
                    <asp:TableCell ID="TableCell13" runat="server">
                        <asp:Label ID="lblTaxCodeFrom" runat="server" Text="Tax Code From"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell14" runat="server">
                        <asp:TextBox ID="txtTaxCodeFrom" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell15" runat="server">
                        <asp:Button ID="btnTaxCodeFrom" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrTaxCodeTo" runat="server">
                    <asp:TableCell ID="TableCell25" runat="server">
                        <asp:Label ID="lblTaxCodeTo" runat="server" Text="Tax Code To"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell26" runat="server">
                        <asp:TextBox ID="txtTaxCodeTo" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell27" runat="server">
                        <asp:Button ID="btnTaxCodeTo" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
