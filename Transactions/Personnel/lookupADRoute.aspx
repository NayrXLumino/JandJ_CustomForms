<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupADRoute.aspx.cs" Inherits="lookupADRoute" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function SendValueToParent() {
            var val1 = document.getElementById('hfValueCode').value;
            var val2 = document.getElementById('hfValueDesc').value;
            var val3 = document.getElementById('hfValueAmount').value;
            window.opener.GetValueFrom_lookupADRoute(val1, val2, val3);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbcAmount = tbr.cells[2];
            window.opener.GetValueFrom_lookupADRoute(tbcCode.innerHTML, tbcDesc.innerHTML, tbcAmount.innerHTML);
            window.close();
            return false;
        }
        ...
        function AssignValue(index) {
            ...
            document.getElementById('hfValueAmount').value = tbcAmount.innerHTML;
        }
    </script>
</head>
<body>
    ...
    <div>
        ...
        <asp:HiddenField ID="hfValueAmount" runat="server" />
    </div>
    </form>
</body>
</html>
