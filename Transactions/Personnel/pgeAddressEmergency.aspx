<%@ Page Title="In Case of Emergency Update" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeAddressEmergency.aspx.cs" Inherits="Transactions_Personnel_pgeAddressEmergency" %>
    ...
    <tr>
        <td valign="top">
            <asp:Table ID="tblLeftControls" runat="server">
                ...
                <asp:TableRow ID="tbrContactPerson" runat="server">
                    ...
                    <asp:TableCell ID="TableCell12" runat="server" ColumnSpan="3">
                        ...
                        <asp:TextBox ID="txtContactPerson" runat="server" Width="512px" MaxLength="100"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" CssClass="reqIndicator" ControlToValidate="txtContactPerson" Font-Bold="true"></asp:RequiredFieldValidator>
                            </div>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrContactRelation" runat="server">
                    <asp:TableCell ID="TableCell13" runat="server">
                        <asp:Label ID="Label4" runat="server" Text="Contact Relation"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell14" runat="server">
                        <asp:TextBox ID="txtContactRelationCode" runat="server" BackColor="Gainsboro" MaxLength="10"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell>
                        <asp:Button ID="btnContactRelation" runat="server" Text="..." Width="22px" />
                    </asp:TableCell>
                    <asp:TableCell>
                        <asp:TextBox ID="txtContactRelationDesc" runat="server" BackColor="Gainsboro" Width="350px" MaxLength="50"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" CssClass="reqIndicator" ControlToValidate="txtContactRelationDesc" Font-Bold="true"></asp:RequiredFieldValidator>
                    </asp:TableCell>
                </asp:TableRow>
        ...
        <td colspan="2">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnY" runat="server" Text="[btnY]" Width="225px" OnClick="btnY_Click" OnClientClick="return clearControlsEmergency()" />
                    </td>
                    <td>
