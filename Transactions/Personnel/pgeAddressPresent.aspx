<%@ Page Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeAddressPresent.aspx.cs" Inherits="Transactions_Personnel_pgeAddressPresent" Title="Present Address Update"%>
            ...
            <asp:Table ID="tblLeftControls" runat="server">
                ...
                <asp:TableRow ID="tbrAddress3" runat="server">
                    ...
                    <asp:TableCell>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" CssClass="reqIndicator" ControlToValidate="txtAddress3Code" Font-Bold="true" Enabled="false"></asp:RequiredFieldValidator>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrTelephoneNo" runat="server">
                    ...
                    <asp:TableCell runat="server" ColumnSpan="3">
                        <div onkeydown="return fn_validateNumericOnly()"><asp:TextBox ID="txtTelephoneNo" runat="server" MaxLength="40" Width="512px"></asp:TextBox>
                   </div> </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrMobileNo" runat="server">
                    ...
                    <asp:TableCell ID="TableCell12" runat="server" ColumnSpan="3">
                        <div onkeydown="return fn_validateNumericOnly()"><asp:TextBox ID="txtMobileNo" runat="server" MaxLength="40" Width="512px"></asp:TextBox>
                    </div></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrEmail" runat="server">
                    <asp:TableCell ID="TableCell13" runat="server">
                        <asp:Label ID="lblEmailAddress" runat="server" Text="Email Address"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell14" runat="server" ColumnSpan="3">
                        <asp:TextBox ID="txtEmailAddress" runat="server" MaxLength="40" Width="512px" CssClass="textareaNormal"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrFiller1" Visible="false">
                    ...
                    <asp:TableCell>
                        <asp:TextBox ID="txtFiller1Desc" runat="server" BackColor="Gainsboro" Width="350px" MaxLength="100"></asp:TextBox>
                ...
                <asp:TableRow ID="tbrFiller2" Visible="false">
                    ...
                    <asp:TableCell Width="200px" ColumnSpan="3">
        ...
        <td colspan="2">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnY" runat="server" Text="[btnY]" Width="225px" OnClick="btnY_Click" OnClientClick="return clearControlsAddressPres()" />
                    </td>
                    <td>
