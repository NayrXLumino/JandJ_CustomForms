<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupRADRoute.aspx.cs" Inherits="Transactions_Personnel_lookupRADRoute" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRADRoute(control, val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRADRoute(control, tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
