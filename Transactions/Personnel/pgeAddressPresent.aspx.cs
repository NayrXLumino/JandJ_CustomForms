...
public partial class Transactions_Personnel_pgeAddressPresent : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (!MGBL.getAccessRights(Session["userLogged"].ToString(), "WFADDPRES"))
        {
        ...
        else
        {
            ...
            LoadComplete += new EventHandler(Transactions_Personnel_pgeAddressPresent_LoadComplete);
    ...
    void Transactions_Personnel_pgeAddressPresent_LoadComplete(object sender, EventArgs e)
    {
        ...
        txtFiller1Desc.Attributes.Add("readOnly", "true");
                        ...
                        using (DALHelper dal = new DALHelper())
                        {
                            ...
                            if (!status.Equals(string.Empty))
                            {
                                ...
                                try
                                {
                                    ...
                                    //MenuLog
                                    SystemMenuLogBL.InsertEditLog("WFADDPRES", true, txtEmployeeId.Text.ToString(), Session["userLogged"].ToString(), "",false);
                        ...
                        try
                        {
                            ...
                            switch (btnY.Text.ToUpper())
                            {
                                ...
                                case "CANCEL":
                                    ...
                                    //MenuLOg
                                    SystemMenuLogBL.InsertEditLog("WFADDPRES", true, txtEmployeeId.Text.ToString(), Session["userLogged"].ToString(), "");
                                    restoreDefaultControls();
                                ...
                                case "DISAPPROVE":
                                    if (!txtRemarks.Text.Trim().Equals(string.Empty))
                                    {
                                        ...
                                        //MenuLOg
                                        SystemMenuLogBL.InsertEditLog("WFADDPRES", true, txtEmployeeId.Text.ToString().ToUpper(), Session["userLogged"].ToString(), "");
                                        restoreDefaultControls();
                    ...
                    if (errMsg1.Equals(string.Empty))
                    {
                        using (DALHelper dal = new DALHelper())
                        {
                            try
                            {
                                ...
                                SystemMenuLogBL.InsertAddLog("WFADDPRES", true, txtEmployeeId.Text.ToString(), Session["userLogged"].ToString(), "",false);
                                dal.CommitTransactionSnapshot();
                            }
                            catch (Exception ex)
                            {
    ...
    {
        MenuGrant userGrant = new MenuGrant(Session["userLogged"].ToString(), "PERSONNEL", "WFADDPRES");    //temp
        ...
        if (Convert.ToBoolean(Resources.Resource.CHIYODASPECIFIC))
        {
            ...
            txtFiller1Desc.TextMode = TextBoxMode.MultiLine;
            txtFiller1Desc.Height = Unit.Pixel(50);
        }
        else
        {
            RequiredFieldValidator2.EnableClientScript = false;
            RequiredFieldValidator2.Enabled = false;
            txtFiller1Desc.TextMode = TextBoxMode.SingleLine;
            txtFiller1Desc.Attributes.Remove("Height");
        }
    }
    ...
    private void initializeCurrentValues()
    {
        ...
        string sqlAddress = @"  SELECT TOP 1 Emt_EmployeeAddress1 [Address1]
                                     ...
                                     , Emt_TelephoneNo [Telephone No]
                                     , Emt_CellularNo [Mobile No]
                                     , Emt_EmailAddress [Email Address]
                                     , Ert_RouteCode [TransportationCode]
                                     , Rte_RouteName [RouteName]
                                     , Rte_Amount [Amount]
                                  FROM T_EmployeeMaster
                                  LEFT JOIN T_AccountDetail Address2
                                    ON Address2.Adt_AccountCode = Emt_EmployeeAddress2
                                   AND Address2.Adt_AccountType = 'BARANGAY'
                                  LEFT JOIN T_AccountDetail Address3
                                    ON Address3.Adt_AccountCode = Emt_EmployeeAddress3
                                   AND Address3.Adt_AccountType = 'ZIPCODE'
                                  LEFT JOIN T_EmployeeRoute 
                                    ON Emt_EmployeeId = Ert_EmployeeId AND Ert_EffectivityDate < GETDATE() 
                                  LEFT JOIN T_RouteMaster
                                    ON Ert_LedgerAlwCol = Rte_LedgerAlwCol
		                           AND Ert_RouteCode = Rte_RouteCode 
        ...
        {
            txtFiller1.Text = dsAddress.Tables[0].Rows[0]["TransportationCode"].ToString();
            txtFiller1Desc.Text = dsAddress.Tables[0].Rows[0]["RouteName"].ToString();
            txtFiller2.Text = dsAddress.Tables[0].Rows[0]["Amount"].ToString();
            ...
            txtMobileNo.Text = dsAddress.Tables[0].Rows[0]["Mobile No"].ToString();
            txtEmailAddress.Text = dsAddress.Tables[0].Rows[0]["Email Address"].ToString();
        }
        else
        {
    ...
    private void enableControls()   
    {
        ...
        switch (txtStatus.Text.ToUpper())
        {
            case "":
                ...
                btnAddress3.Enabled = !Convert.ToBoolean(Resources.Resource.CHIYODASPECIFIC);
                RequiredFieldValidator1.Enabled = !Convert.ToBoolean(Resources.Resource.CHIYODASPECIFIC);
                    ...
                    switch (ds.Tables[0].Rows[i]["Cfl_ColName"].ToString().ToUpper())
                    {
                        case "AMT_FILLER01":
                              ...
                              && ds.Tables[0].Rows[i]["Cfl_Status"].ToString().ToUpper().Equals("A"))
                            {
                                ...
                                btnFiller1.Attributes.Add("OnClick", "javascript:return lookupADRoute();");
                            }
                            else
                            {
    ...
    private DataRow PopulateDR(string Status, string ControlNum)
    {
        ...
        dr["Amt_CellularNo"] = txtMobileNo.Text;
        dr["Amt_EmailAddress"] = txtEmailAddress.Text;
        ...
        dr["Amt_Filler1"] = txtFiller1.Text.ToUpper();
        dr["Amt_Filler2"] = txtFiller2.Text.ToUpper();
        dr["Amt_Filler3"] = txtFiller3.Text.ToUpper();
    ...
    private void restoreDefaultControls()
    {
        ...
        txtFiller1Desc.Text = string.Empty;
    ...
    private void loadTransactionDetail()
    {
        ...
        txtMobileNo.Text = dr["CellularNo"].ToString();
        txtEmailAddress.Text = dr["EmailAddress"].ToString();
        txtFiller1.Text = dr["Transportation"].ToString();
        txtFiller1Desc.Text = dr["RouteName"].ToString();
        txtFiller2.Text = dr["Amount"].ToString();
        ...
        {
            string pageUrl = @"pgeAddressPresent.aspx";
