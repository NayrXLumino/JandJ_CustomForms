<%@ Page Title="" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeLaborHrAdjReport.aspx.cs" Inherits="Transactions_Payroll_pgeLaborHrAdjReport" %>
    ...
    <div class="dhtmlgoodies_answer" style="width: 895px; height: 1px; left: 0px; top: 0px;">
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                ...
                <asp:TableRow ID="tbrCostcenter" runat="server" Visible="false">
                ...
                <asp:TableRow ID="tbrStatus" runat="server" Visible="false">
                ...
                <asp:TableRow ID="tbrBatchNo" runat="server" Visible="false">
        ...
        <div>
            <asp:Panel ID="pnlInclude" runat="server" Width="895px" GroupingText="Include" Height="75px">
                <asp:CheckBoxList ID="cblInclude" runat="server" Width="884px" RepeatColumns="5">
                    ...
                    <asp:ListItem Value="Remarks">Status</asp:ListItem>--%>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td style="width: 205px" align="center"  style="display:none">
            ...
            <tr>
                <td>
                    <asp:Panel ID="pnlResult" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="350px" ScrollBars="Both" Width="898px" >
                        <asp:GridView ID="dgvResult" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="896px" Font-Size="11px" OnRowCreated="dgvResult_RowCreated" ShowFooter="True" 
                            Visible="false" >
                        ...
                        <dx:ASPxGridView ID="agvResult" runat="server" Width="100%" AutoGenerateColumns="true">
