<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupPLRepCostCenterLine.aspx.cs" Inherits="Transactions_Personnel_lookupPLRepCostCenterLine" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRPLCostcenterLine(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRPLCostcenterLine(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
