<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupPLRepCheckerApprover.aspx.cs" Inherits="Transactions_Personnel_lookupPLRepCheckerApprover" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRPLCheckerApprover(control,val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRPLCheckerApprover(control,tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
