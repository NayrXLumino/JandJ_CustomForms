<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupSWRepShift.aspx.cs" Inherits="Transactions_TimeModification_lookupSWRepShift" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRSWShift(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRSWShift(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
