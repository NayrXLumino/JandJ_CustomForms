<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupTKRepCostCenter.aspx.cs" Inherits="Transactions_TimeModification_lookupTKRepCostCenter" EnableEventValidation="false"  %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupWRRepCostCenter(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupWRRepCostCenter(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
