<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupTKRepCostCenterLine.aspx.cs" Inherits="Transactions_TimeModification_lookupTKRepCostCenterLine" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Lookup Costcenter Line</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRTKCostcenterLine(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRTKCostcenterLine(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
