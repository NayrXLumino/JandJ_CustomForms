<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupTKRepEmployee.aspx.cs" Inherits="Transactions_TimeModification_lookupTKRepEmployee" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Employee Lookup</title><style type="text/css">
        body
        {
            font-family:Arial;
            font-size:12px;
    ...
    function gridSelect(val)
    {
        ...
        temp.text = tbl.rows[parseInt(val,10)+1].cells[1].innerHTML + ", " + tbl.rows[parseInt(val,10)+1].cells[2].innerHTML;
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRTKEmployee(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRTKEmployee(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
            ...
            <tr>
                <td>
                    ...
                    <asp:Panel ID="pnlResult" runat="server" Height="180px" ScrollBars="Both" Width="720px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">
                        <asp:GridView ID="dgvResult" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="716px" OnRowDataBound="Lookup_RowDataBound" OnSelectedIndexChanged="dgvResult_SelectedIndexChanged" OnRowCreated="dgvResult_RowCreated" OnSelectedIndexChanging="dgvResult_SelectedIndexChanging">
