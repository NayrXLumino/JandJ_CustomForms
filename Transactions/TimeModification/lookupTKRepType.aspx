<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupTKRepType.aspx.cs" Inherits="Transactions_TimeModification_lookupTKRepType" EnableEventValidation="false"%>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Modification Lookup</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRTKType(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRTKType(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
