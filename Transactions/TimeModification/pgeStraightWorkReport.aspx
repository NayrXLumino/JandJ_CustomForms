<%@ Page Title="Straight Work Report" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeStraightWorkReport.aspx.cs" Inherits="Transactions_TimeModification_pgeStraightWorkReport" %>
    ...
    <div class="dhtmlgoodies_answer" style="width: 895px; height: 1px; left: 0px; top: 0px;">
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                ...
                <asp:TableRow ID="tbrShift" runat="server">
                    <asp:TableCell ID="TableCell25" runat="server">
                        <asp:Label ID="lblShift" runat="server" Text="Shift(s)"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell26" runat="server">
                        <asp:TextBox ID="txtShift" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell27" runat="server">
                        <asp:Button ID="btnShift" runat="server" Text="..." UseSubmitBehavior="False" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="400px" VerticalAlign="Top">
                                    <asp:Table ID="tblFilter21" runat="server" CellPadding="0" CellSpacing="0">
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlStraightWorkDate" runat="server" GroupingText="Straight Work Date" Width="390px">
                                                    <table>
                                                        <tr>
                                                            <td>
