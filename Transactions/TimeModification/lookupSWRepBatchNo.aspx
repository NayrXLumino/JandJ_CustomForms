<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupSWRepBatchNo.aspx.cs" Inherits="Transactions_TimeModification_lookupRSWBatchNo" %>
   ...
   <style type="text/css">
    ...
    <script type="text/javascript">
        function gridSelect(val) {
            ...
            temp.text = "[" + tbl.rows[parseInt(val, 10) + 1].cells[0].innerHTML + "] " + tbl.rows[parseInt(val, 10) + 1].cells[1].innerHTML + " - " + tbl.rows[parseInt(val, 10) + 1].cells[2].innerHTML;
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRSWBatchNo(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRSWBatchNo(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
