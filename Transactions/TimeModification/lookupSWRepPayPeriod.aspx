<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupSWRepPayPeriod.aspx.cs" Inherits="Transactions_TimeModification_lookupSWRepPayPeriod" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRSWPayPeriod(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRSWPayPeriod(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
