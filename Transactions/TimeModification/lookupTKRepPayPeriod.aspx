<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupTKRepPayPeriod.aspx.cs" Inherits="Transactions_TimeModification_lookupTKRepPayPeriod" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRTKPayPeriod(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRTKPayPeriod(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
