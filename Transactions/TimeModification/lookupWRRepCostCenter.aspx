<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupWRRepCostCenter.aspx.cs" Inherits="Transactions_TimeModification_lookupWRRepCostCenter" EnableEventValidation="false"  %>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRTKCostcenter(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRTKCostcenter(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
