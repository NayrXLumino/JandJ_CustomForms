<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupSWRepCheckerApprover.aspx.cs" Inherits="Transactions_TimeModification_lookupSWRepCheckerApprover" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRSWCheckerApprover(control, val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRSWCheckerApprover(control, tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
