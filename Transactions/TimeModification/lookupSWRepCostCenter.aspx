<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupSWRepCostCenter.aspx.cs" Inherits="Transactions_TimeModification_lookupSWRepCostCenter" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupSWRepCostCenter(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupSWRepCostCenter(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
