<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupTKRepStatus.aspx.cs" Inherits="Transactions_TimeModification_lookupTKRepStatus" EnableEventValidation="false"%>
...
<head runat="server">
    ...
    function SendValueToParent()
    {
        ...
        window.opener.GetValueFrom_lookupRTKStatus(val);
        window.close();
        return false;
    }
    ...
    function SendValueToParent2(index)
    {
        ...
        var tbc = tbr.cells[0];
        window.opener.GetValueFrom_lookupRTKStatus(tbc.innerHTML);
        window.close();
        return false;
    }
    </script>
