<%@ Page Title="CostCenter Individual Update" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeCostCenterIndividualUpdate.aspx.cs" Inherits="Transactions_WorkInformation_pgeCostCenterIndividualUpdate" %>
        ...
        <tr>
            <td valign="top">
                <asp:Table ID="tblLeftControls" runat="server">
                    ...
                    <asp:TableRow ID="tbrCostCenterFrom" runat="server" VerticalAlign="Top">
                        <asp:TableCell ID="TableCell31" runat="server" >
                            <asp:Label ID="Label2" runat="server" Text="From Costcenter"></asp:Label>
                        </asp:TableCell>
                        <asp:TableCell ID="TableCell71" runat="server" >
                            <asp:TextBox ID="txtFromCostCenterCode" runat="server" BackColor="Gainsboro" MaxLength="12"/>
                            &nbsp; - &nbsp; 
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="txtFromCostCenterDesc" runat="server" BackColor="Gainsboro" Width="500px" TextMode="MultiLine"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" CssClass="reqIndicator" ControlToValidate="txtFromCostCenterCode" Font-Bold="true"></asp:RequiredFieldValidator>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow ID="tbrCostCenterTo" runat="server" VerticalAlign="Top">
                        ...
                        <asp:TableCell ID="TableCell91" runat="server">
                            <asp:TextBox ID="txtToCostCenterCode" runat="server" MaxLength="12" BackColor="Gainsboro"/>
                            <asp:Button ID="btnToCostCenter" runat="server" Text="..." Width="22px" />
                        </asp:TableCell>
                        <asp:TableCell runat="server">
                            <asp:TextBox ID="txtToCostCenterDesc" runat="server" BackColor="Gainsboro" Width="500px" TextMode="MultiLine"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" CssClass="reqIndicator" ControlToValidate="txtToCostCenterCode" Font-Bold="true"></asp:RequiredFieldValidator>
                        </asp:TableCell>
                    </asp:TableRow>
            ...
            <td colspan="2">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnY" runat="server" Text="[btnY]" Width="225px" OnClick="btnY_Click" OnClientClick="return clearControlsCostcenter()" />
                        </td>
                        <td>
