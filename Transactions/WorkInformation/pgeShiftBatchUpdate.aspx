<%@ Page Title="Shift Batch Update" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeShiftBatchUpdate.aspx.cs" Inherits="Transactions_WorkInformation_pgeShiftBatchUpdate" %>
                        ...
                        <asp:Table ID="tblEntryLeft" runat="server" Width="450px" >
                            <asp:TableRow ID="tbrEffectivityDate" runat="server">
                                <asp:TableCell ID="TableCell1" runat="server">
                                    <asp:Label ID="lblEffectivityDate" runat="server" Text="Process Date" Width="82px"></asp:Label>
                                </asp:TableCell>
                            ...
                            <asp:TableRow ID="tbrFromShift" runat="server">
                                ...
                                </asp:TableCell></asp:TableRow><asp:TableRow ID="tbrToShift" runat="server">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            ...
                            <asp:Button ID="btnClear" runat="server" Text="CLEAR" Width="106px" OnClick="btnClear_Click" CausesValidation="False" UseSubmitBehavior="False" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
