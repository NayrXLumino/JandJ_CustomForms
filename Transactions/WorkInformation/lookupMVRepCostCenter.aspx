<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupMVRepCostCenter.aspx.cs" Inherits="Transactions_WorkInformation_lookupMVRepCostCenter" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRMVCostcenter(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRMVCostcenter(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
