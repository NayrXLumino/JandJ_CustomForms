<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupMVRepPayPeriod.aspx.cs" Inherits="Transactions_WorkInformation_lookupMVRepPayPeriod" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRMVPayPeriod(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRMVPayPeriod(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
