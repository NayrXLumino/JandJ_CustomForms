<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupMVRepCostCenterLine.aspx.cs" Inherits="Transactions_WorkInformation_lookupMVRepCostCenterLine" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRMVCostcenterLine(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRMVCostcenterLine(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
