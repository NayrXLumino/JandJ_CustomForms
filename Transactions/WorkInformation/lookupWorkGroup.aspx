<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupWorkGroup.aspx.cs" Inherits="Transactions_WorkInformation_lookupWorkGroup" EnableEventValidation="False" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Lookup Workgroup</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    <script type="text/javascript">
        function SendValueToParent() {
            ...
            var val2 = document.getElementById('hfValueCode1').value;
            var val3 = document.getElementById('hfValueCode2').value;
            var val4 = document.getElementById('hfValueDesc').value;
            
            window.opener.GetValueFrom_lookupWorkGroup(val1, val2, val3, val4);
            var txtBox = window.opener.document.getElementById('ctl00_ContentPlaceHolder1_txtFromGroup');
            if (txtBox != null)
                txtBox.focus();
            window.close();
            return false;
        ...
        function SendValueToParent2(index) {
            ...
            var tbcCode1 = tbr.cells[0];
            var tbcCode2 = tbr.cells[1];
            var tbcDesc = tbr.cells[2];
            var val1 = document.getElementById('hfControl').value;

            window.opener.GetValueFrom_lookupWorkGroup(val1, tbcCode1.innerHTML, tbcCode2.innerHTML, tbcDesc.innerHTML);
            var txtBox = window.opener.document.getElementById('ctl00_ContentPlaceHolder1_txtFromGroup');
            if (txtBox != null)
                txtBox.focus();
            window.close();
        ...
        function AssignValue(index) {
            ...
            document.getElementById('hfValueCode1').value = tbcCode1.innerHTML;
            document.getElementById('hfValueCode2').value = tbcCode2.innerHTML;
...
<body>
    ...
    <div>
        ...
        <asp:HiddenField ID="hfValueCode1" runat="server"/>
        <asp:HiddenField ID="hfValueCode2" runat="server"/>
