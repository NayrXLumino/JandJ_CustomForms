<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupMVRepFromTo.aspx.cs" Inherits="Transactions_WorkInformation_lookupFromTo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            var val1 = document.getElementById('hfValue').value;
            var val2 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupRMVFromTo(val1, val2);    
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            var val2 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupRMVFromTo(tbc.innerHTML, val2);  
            window.close();
            return false;
        }
    </script>
