<%@ Page Title="Workgroup Batch Update" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeWorkGroupBatchUpdate.aspx.cs" Inherits="Transactions_WorkInformation_pgeWorkGroupBatchUpdate" %>
                        ...
                        <asp:Table ID="tblEntryLeft" runat="server" Width="450px" >
                            <asp:TableRow ID="tbrEffectivityDate" runat="server">
                                <asp:TableCell ID="TableCell1" runat="server">
                                    <asp:Label ID="lblEffectivityDate" runat="server" Text="Effectivity Date" Width="87px"></asp:Label>
                                </asp:TableCell>
                            ...
                            <asp:TableRow ID="tbrFromGroup" runat="server">
                                <asp:TableCell ID="TableCell3" runat="server">
                                    <asp:Label ID="lblFromGroup" runat="server" Text="From Group"></asp:Label>
                                </asp:TableCell>
                                <asp:TableCell ID="TableCell4" runat="server">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtFromGroupCode" runat="server" Width="80px" BackColor="Gainsboro" AutoPostBack="true" OnTextChanged="txtFromGroupCode_TextChanged"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Button ID="btnFromGroup" runat="server" Text="..." Width="22px" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtFromGroupDesc" runat="server" Width="243px" BackColor="Gainsboro"></asp:TextBox>
                                            </td>
                            ...
                            <asp:TableRow ID="tbrToGroup" runat="server">
                                ...
                                <asp:TableCell ID="TableCell6" runat="server">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtToGroupCode" runat="server" Width="80px" BackColor="Gainsboro"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Button ID="btnToGroup" runat="server" Text="..." Width="22px" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtToGroupDesc" runat="server" Width="243px" BackColor="Gainsboro"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" Font-Bold="True" CssClass="reqIndicator" ControlToValidate="txtToGroupCode"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:TableCell>
                ...
                <tr>
                    <td colspan="2">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" Text="Costcetner" Width="90px"></asp:Label></td><td>
                                    <asp:DropDownList 
            ...
            <asp:Panel ID="pnlBound" runat="server" Width="890px" GroupingText="Bound">
                <table width="100%">
                    <tr>
                        ...
                        <td align="center">
                            <asp:Label ID="ibiInclude" runat="server" Text="Included in Change"></asp:Label>
                        </td>
                    </tr>
                    <tr>
