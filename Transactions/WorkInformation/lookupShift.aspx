<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupShift.aspx.cs" Inherits="Transactions_WorkInformation_lookupShift2" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function SendValueToParent() {
            ...
            var val3 = document.getElementById('hfDesc').value;
            window.opener.GetValueFrom_lookupShift(val1, val2, val3);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var val1 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupShift(val1, tbcCode.innerHTML, tbcDesc.innerHTML);
            window.close();
            return false;
        }
        ...
        function AssignValue(index) {
            ...
            document.getElementById('hfValue').value = tbcCode.innerHTML;
            document.getElementById('hfDesc').value = tbcDesc.innerHTML;
        }
    </script>
</head>
<body>
