<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupMVRepStatus.aspx.cs" Inherits="Transactions_WorkInformation_lookupMVRepStatus" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRMVStatus(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRMVStatus(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
