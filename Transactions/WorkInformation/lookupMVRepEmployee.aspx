<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupMVRepEmployee.aspx.cs" Inherits="Transactions_WorkInformation_lookupMVRepEmployee" EnableEventValidation="false"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRMVEmployee(val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRMVEmployee(tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
