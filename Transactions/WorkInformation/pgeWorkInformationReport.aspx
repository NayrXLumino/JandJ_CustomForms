<%@ Page Title="Work Information Report" Language="C#" MasterPageFile="~/pgeMaster.master" AutoEventWireup="true" CodeFile="pgeWorkInformationReport.aspx.cs" Inherits="Transactions_WorkInformation_pgeWorkInformationReport" %>
        ...
        <div>
            <asp:Table ID="tblFilter1" runat="server" Width="895px">
                <asp:TableRow ID="tbrEmployee" runat="server">
                    <asp:TableCell ID="TableCell11" runat="server" Width="120px">
                ...
                <asp:TableRow ID="tbrBatchNo" runat="server" Width="895px">
                    <asp:TableCell runat="server" Width="120px">
                        <asp:Label ID="lblBatchNo" runat="server" Text="Batch No(s)"></asp:Label>
                    </asp:TableCell>
                ...
                <asp:TableRow ID="tbrCostcenterLine" runat="server">
                    <asp:TableCell ID="TableCell13" runat="server" Width="120px">
                        <asp:Label ID="Label2" runat="server" Text="Costcenter Line(s)"></asp:Label>
                    </asp:TableCell>
                ...
                <asp:TableRow ID="tbrFrom" runat="server">
                    <asp:TableCell ID="TableCell1" runat="server">
                        <asp:Label ID="lblFrom" runat="server" Text="From"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell2" runat="server">
                        <asp:TextBox ID="txtFrom" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell3" runat="server">
                        <asp:Button ID="btnFrom" runat="server" Text="..." UseSubmitBehavior="false" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="tbrTo" runat="server">
                    <asp:TableCell ID="TableCell10" runat="server">
                        <asp:Label ID="Label1" runat="server" Text="To"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell111" runat="server">
                        <asp:TextBox ID="txtTo" runat="server" Width="730px"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell12" runat="server">
                        <asp:Button ID="btnTo" runat="server" Text="..." UseSubmitBehavior="false" Width="22px" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="400px" VerticalAlign="Top">
                                    <asp:Table ID="tblFilter21" runat="server" CellPadding="0" CellSpacing="0">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td style="width:117px">
                                                            <asp:Label ID="lblMoveType" runat="server" Text="Type"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlMoveType" runat="server" Width="150px">
                                                                <asp:ListItem Selected="True" Value="ALL">ALL</asp:ListItem>
                                                                <asp:ListItem Value="S">SHIFT</asp:ListItem>
                                                                <asp:ListItem Value="C">COSTCENTER</asp:ListItem>
                                                                <asp:ListItem Value="R">RESTDAY</asp:ListItem>
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlPayrollPeriod" runat="server" GroupingText="Payroll Period" Width="390px">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblPayrollPeriod" runat="server" Text="Period"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtPayrollPeriod" runat="server" Width="200px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="btnPayrollPeriod" runat="server" Text="..." Width="22px" />
                                                            </td>
                                                            <td>
                                                                <asp:CheckBox Visible="false" ID="chkAdjustment" Text="Adjustment" runat="server"/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </asp:Panel>
                                            ...
                                            <asp:TableCell>
                                                <asp:Panel ID="pnlEffectivityDate" runat="server" GroupingText="Effectivity Date" Width="390px">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblOTDateFrom" runat="server" Text="From"></asp:Label>
                                                            </td>
                                                            <td>
