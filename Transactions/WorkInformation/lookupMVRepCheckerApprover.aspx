<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupMVRepCheckerApprover.aspx.cs" Inherits="Transactions_WorkInformation_lookupMVRepCheckerApprover" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupRMVCheckerApprover(control, val);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index) {
            ...
            var tbc = tbr.cells[0];
            window.opener.GetValueFrom_lookupRMVCheckerApprover(control, tbc.innerHTML);
            window.close();
            return false;
        }
    </script>
