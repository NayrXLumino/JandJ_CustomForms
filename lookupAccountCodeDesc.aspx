<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupAccountCodeDesc.aspx.cs" Inherits="lookupGenericCodeDesc" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function SendValueToParent()
        {
            ...
            window.opener.GetValueFrom_lookupAccountCodeDesc(val1, val2, val3);
            window.close();
            return false;
        }
        ...
        function SendValueToParent2(index)
        {
            ...
            var val1 = document.getElementById('hfControl').value;
            window.opener.GetValueFrom_lookupAccountCodeDesc(val1, tbcCode.innerHTML, tbcDesc.innerHTML);
            window.close();
            return false;
        }
