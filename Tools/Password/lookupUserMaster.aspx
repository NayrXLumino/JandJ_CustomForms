<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupUserMaster.aspx.cs" Inherits="Tools_Password_lookupUserMaster" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>User Master Lookup</title>
    <style type="text/css">
        body
        {
            font-family:Arial;
    ...
    <script type="text/javascript">
    	function SendValueToParent() {
            ...
            window.opener.GetValueFrom_lookupUserMaster(val1,val2,val3);
            window.close();
			return false;
		}
		...
		function SendValueToParent2(index)
        {
            ...
            window.opener.GetValueFrom_lookupUserMaster(tbr.cells[0].innerHTML, tbr.cells[1].innerHTML, tbr.cells[2].innerHTML);
            window.close();
            return false;
        }
